...
export function PhotoAnalyzer() {
  return (
    <button
      className="flex items-center gap-2 px-3 py-2 text-sm text-gray-500 border border-dashed border-gray-300 rounded-xl hover:border-gray-400 transition-colors"
